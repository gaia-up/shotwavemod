# This script performs 3D Seismic Wave and Shot Simulation using Spectral Element Method
...
# HOW TO RUN
# Step1: Define parameterization in  seismic3dsem.par   (Parameters are from  row 25 to 46 !)
...
scale = 0.5
plt.suptitle('3D SHOT RECORD SPECTRAL ELEMENT METHOD')
...
i = 2  #wavefield nth
values = np.load('%s/wavefieldSEM_%s.npy'%(path,i) )
